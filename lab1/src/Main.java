...
public class Main {
    public static void main(String[] args) throws IOException {
        for(;;) {
            ...
            String[] arrayStr = new String[]{"perviy", "vtoroy", "tretiy"};
            ...
            list2.add(new User("Kolya", 20));
            list2.add(new User("Katya", 18));
            list2.add(new User("Kitya", 25));

            System.out.println(list2);
            System.out.println(list2.contains(new User("Kolya", 30)));
            System.out.println(list2.contains(new User("Kolya", 20)));
            break;
        }
